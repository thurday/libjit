...
void _jit_memory_free(void *value);
...
struct _jit_insn
{
    ...
    ejit_linked_list_t        used;
    ejit_linked_list_t        in;
    ejit_linked_list_t        out;
    ejit_linked_list_t        def;
    ejit_linked_list_t        prev_insn;
    ejit_call_params_t        *call_params;
    jit_insn_t            prev;
    jit_insn_t            next;
#endif
};
...
#if defined(__i386) || defined(__i386__) || defined(_M_IX86)
    jit_memory_pool        ejit_vreg_pool;
    jit_memory_pool        ejit_critical_point_pool;
    jit_memory_pool        ejit_list_pool;
    jit_memory_pool        ejit_frame_pool;
    jit_memory_pool        memory_pool;
    jit_memory_pool        ejit_linked_list_pool;
#endif
