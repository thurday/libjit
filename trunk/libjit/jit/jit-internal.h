...
struct _jit_insn
{
	...
	lir_linked_list_t		used;
	lir_linked_list_t		in;
	lir_linked_list_t		out;
	lir_linked_list_t		def;
	lir_linked_list_t		prev_insn;
	lir_call_params_t		*call_params;
	jit_insn_t			prev;
	jit_insn_t			next;
#endif
};
...
#if defined(__i386) || defined(__i386__) || defined(_M_IX86)
	jit_memory_pool		lir_vreg_pool;
	jit_memory_pool		lir_critical_point_pool;
	jit_memory_pool		lir_list_pool;
	jit_memory_pool		lir_frame_pool;
	jit_memory_pool		memory_pool;
	jit_memory_pool		lir_linked_list_pool;
#endif
