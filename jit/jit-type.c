...
{
	// Current approach of returning structures in libjit was unclear for me. If the abi is internal, and the
	// return_type is a structure, the abi is set to cdecl.
//	if(abi == jit_abi_internal && (jit_type_is_struct(return_type) || jit_type_is_union(return_type)))
//	{
//		abi = jit_abi_cdecl;
//	}
	jit_type_t type;
